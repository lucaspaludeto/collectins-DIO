...
public class ExercicioProposto01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Insira as 7 cores do Arco-Íris");
		...
		System.out.println("A quantidade de cores que o arco-íris tem: " + coresArcoIris.size() + " cores");
		
		Set<String> coresArcoIris1 = new TreeSet<>(coresArcoIris);
		System.out.println("Exiba as cores em ordem alfabética: " + coresArcoIris1);
